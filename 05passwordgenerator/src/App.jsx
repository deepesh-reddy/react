...
function App() {
  ...
  return (
    <div className=' bg-gray-600 w-full h-screen p-8'>
      <div className="w-full max-w-md mx-auto shadow-md rounded-lg px-4 py-3   bg-gray-800 text-red-500">
    ...
    <div className="flex shadow rounded-lg overflow-hidden mb-4">
      ...
      <div className='flex text-sm gap-x-2'>
        ...
        <div className='flex items-center gap-x-1'>
          <input type="checkbox" name="" id="" defaultValue={numberAllowed}
          onChange={()=>{
        ...
        <div className='flex items-center gap-x-1'>
          <input type="checkbox" name="" id="" defaultValue={charAllowed}
          onChange={()=>{
